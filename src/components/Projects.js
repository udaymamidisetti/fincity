  ...
  return (
    <div className="pt-[100px]" id="projects">
      ...
      {projects.map((e, i) => (
        <div
          key={i}
          className="w-[992px] h-[524px] flex items-center rounded-[24px] justify-between bg-[#fff] m-auto mt-[100px]"
        >
          <div className="w-[406px] pl-[40px]">
            <h1 className="font-bold text-[40px] leading-[60px]">{e.name}</h1>
